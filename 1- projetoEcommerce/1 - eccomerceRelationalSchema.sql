...
create table delivery(
    ...
    idClient int,
    idOrder int,
    trackingCode varchar(16),
	orderStatus enum('enviado','entregue','Em processamento') default 'Em processamento',
    primary key(idClient, idOrder, idDelivery),
